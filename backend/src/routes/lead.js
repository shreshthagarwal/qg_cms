...
router.post('/:id/convert', async (req, res) => {
    try {
        const { id } = req.params;
        const { password, courseName, role, durationMonths, totalFees, paidFees, startDate, endDate, 
        // Personal Details
        ...
        // Educational Details
        tenthPercentage, twelfthPercentage, tenthMarksheetUrl, twelfthMarksheetUrl, currentCollege, collegeAddress, collegeCity, collegeState, cgpa, collegeMarksheetUrl, graduatingYear } = req.body;
        const db = (0, database_1.default)();
