...
router.get('/submissions', auth_1.authenticate, auth_1.authorizeAdmin, async (req, res) => {
    try {
...
router.get('/:id/submissions', auth_1.authenticate, auth_1.authorizeAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        const db = (0, database_1.getDb)();
...
router.get('/:id/assigned-students', auth_1.authenticate, auth_1.authorizeAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        const db = (0, database_1.getDb)();
...
// Grade a submission
router.patch('/submissions/:id/grade', auth_1.authenticate, auth_1.authorizeAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
router.post('/:id/students', auth_1.authenticate, auth_1.authorizeAdmin, async (req, res) => {
    try {
        const { id } = req.params;
...
router.delete('/:id/students/:studentId', auth_1.authenticate, auth_1.authorizeAdmin, async (req, res) => {
    try {
...
// Get my submissions
router.get('/my-submissions', auth_1.authenticate, async (req, res) => {
    try {
        const studentId = req.user?.id;
        const db = (0, database_1.getDb)();
